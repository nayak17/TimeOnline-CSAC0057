...
.tabcontent {
  ...
  <a href ="AddBrand.aspx"<button class="tablinks" onclick="openCity(event, 'Brands')" id="brands">Brands</button></a></br></br>
  <a href ="AddProduct.aspx"<button class="tablinks" onclick="openCity(event, 'Products')" id="Product">Products</button></a>
</div>
